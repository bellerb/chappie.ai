...
'''
            ...
            print(state)
            if os.path.exists(f'{player}/logs') is False:
...
'''
                ...
                if os.path.exists(f'skills/chess/data/models/{player}/weights') is False:
                    # Create folder
                    os.makedirs(f'skills/chess/data/models/{player}/weights')
                torch.save({
                ...
                t_log.to_csv(
                    f'skills/chess/data/models/{player}/logs/training_log.csv', index=False)
            elif t_choice == 1:
                print(
                    '''
-------------------------------------------------
...
'''
                ...
                m_choice = tools.give_options(model_list)
                players.append(
                    f'skills/chess/data/models/{model_list[m_choice].split("(")[0].strip()}/parameters.json')
                print(
                    '''
-------------------------------------------------
